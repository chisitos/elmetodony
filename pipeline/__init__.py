"""ALBA — motor editorial para arquitectura interior y remodelación.
...
Pipeline de agentes:
  ...
  4. editor        -> agente editor (reescribe con la voz de ALBA)
  5. site.generate -> arma el sitio estático a partir de los artículos publicados
"""
